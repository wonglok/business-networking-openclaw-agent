...
export class IsolatedVmContext {
    ...
    async compileAndExecuteFunction(userScript: string, args = {}): Promise<any> {
        ...
        if (executeFnReference.typeof === undefined) {
            throw new Error("The function 'execute' could not be found. " + "We couldn't find the requested function.");
        }
