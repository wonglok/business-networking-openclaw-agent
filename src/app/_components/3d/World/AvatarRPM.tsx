...
export function AvatarRPM() {
  ...
  const fbx = {
    start: useFBX(`/avatar/motion/jump_start.fbx`),
    loop: useFBX(`/avatar/motion/jump_loop.fbx`),
    land: useFBX(`/avatar/motion/jump_land.fbx`),

    //
    idle: useFBX(`/avatar/motion/idle.fbx`),
    run: useFBX(`/avatar/motion/run.fbx`),
  ...
  return (
    <>
      <group frustumCulled={false} name='main-player-glb' position={[0, -0.9, 0]}>
