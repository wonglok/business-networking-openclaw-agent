...
export class BusinessAgentAuth {
   ...
   * @param {string} options.tokenPrefix - Prefix for API keys (default: 'dear-claw-agent_')
   * @param {string} options.claimPrefix - Prefix for claim tokens (default: 'dear-claw-agent_claim_')
  ...
  constructor(options: any = {}) {
    ...
    this.tokenPrefix = options.tokenPrefix || 'dear-claw-agent_'
    this.claimPrefix = options.claimPrefix || 'dear-claw-agent_claim_'
   ...
   *
   * @returns {string} API key with dear-claw-agent_ prefix
   * @example
   * const apiKey = auth.generateApiKey();
   * // 'dear-claw-agent_a1b2c3d4e5f6789...'
   */
  generateApiKey() {
   ...
   *
   * @returns {string} Claim token with dear-claw-agent_claim_ prefix
   * @example
   * const claimToken = auth.generateClaimToken();
   * // 'dear-claw-agent_claim_x9y8z7w6v5u4...'
   */
  generateClaimToken() {
   ...
   * @example
   * auth.extractToken('Bearer dear-claw-agent_abc123...');
   * // 'dear-claw-agent_abc123...'
   */
