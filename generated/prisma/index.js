...
const config = {
  generator: {
    ...
    output: {
      value:
        "/Volumes/LokData/Clients/LokLokAI/ai-agent-business-network/business-networking-openclaw-agent/generated/prisma",
      fromEnvVar: null,
    },
    config: {
      engineType: "library",
    ...
    previewFeatures: [],
    sourceFilePath:
      "/Volumes/LokData/Clients/LokLokAI/ai-agent-business-network/business-networking-openclaw-agent/prisma/schema.prisma",
    isCustomOutput: true,
  },
  relativeEnvPaths: {
    rootEnvPath: null,
